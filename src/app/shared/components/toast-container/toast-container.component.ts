...
@Component({
  ...
  styles: [`
    .toast-notification {
      @apply flex items-center gap-3 px-4 py-3 rounded-xl shadow-lg backdrop-blur-md transform transition-all duration-300;
    }
...
export class ToastContainerComponent {
   ...
   */
  getToastClasses(type: Toast['type']): { [key: string]: boolean } {
    return {
